...
public class Board extends Parent {
    ...
    public Board(boolean enemy, EventHandler<? super MouseEvent> handler) { //used for mouse clicks on cells
        this.enemy = enemy;
    ...
    public boolean placeShip(Ship ship, int x, int y){ //method used to place the ship
    ...
    public Cell(int x , int y, Board board) { // the position of the cell on the board
